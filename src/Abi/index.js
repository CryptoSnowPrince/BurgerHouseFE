...
export const PUBLIC_URL = "https://burgerhouse.web.app"
...
// export const BurgerHouse = '0xf5341377d0e6368C16097E31c27bd2283A9Cdc8E'; // without withdraw
...
export const START_TIME = 1669881600 // without withdraw
export const EPOCH_LENGTH = 2592000
export const WITHDRAW_TIME = 86400

export const BurgerHouse = '0x370D30b3f8437c2f40E203c1307e84a4BB6d672e'; // without withdraw
...
const BurgerHouse_ABI = [
	...
	},
	{
		...
		"outputs": [
			...
			{
				"internalType": "uint256",
				"name": "requestEpochNumber",
				"type": "uint256"
			},
			{
				"internalType": "uint256",
				"name": "pendingClaimEpochNumber",
				"type": "uint256"
			},
			{
				"internalType": "uint256",
...
export function getTokenAbi(web3) {
	return new web3.eth.Contract(TOKEN_ABI, BUSD_ADDRESS);
}
